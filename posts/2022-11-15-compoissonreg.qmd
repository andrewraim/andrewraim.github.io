...
(0.8.0) of the package, these computations have have revisited in a more
...
package. The intention is to include a vignette version of this report in the
package going forward, to be updated along with the software.
