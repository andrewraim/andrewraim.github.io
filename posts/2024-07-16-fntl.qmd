...
can make use of variables in the environment within their body, and be passed
as arguments to other functions. Use of lambdas may be especially appealing for
...
- Deployed on [CRAN][cran-url]
- Source on [Github][github-url]


[lambda-url]: https://en.cppreference.com/w/cpp/language/lambda
[github-url]: https://github.com/andrewraim/fntl
[cran-url]: https://cran.r-project.org/package=fntl
