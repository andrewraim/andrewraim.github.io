...
X, and Unix which was developed at Bell Labs. Linux is bundled in various forms
...
mainstream Linux distribution (e.g., Debian or Ubuntu) that includes a desktop
environment (e.g., Xfce, KDE, or Gnome). This should provide a usable OS after
...
ready to to set up Linux to boot as the computer's actual OS, most installers
...
- [Niri](https://yalter.github.io/niri) A scrolling window manager for Wayland
  that supports some aspects of tiling. I find this one very natural and
  ...
  screen at a time. User can navigate within and between workspaces, and
