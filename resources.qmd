...
- [Debian](https://www.debian.org) A distribution of Linux maintained by
  the Debian cummunity. Ubuntu, Linux Mint, and many other distributions are
  based on it. Debian may be prefered over Ubuntu if you do not want to use
  [Snap](https://snapcraft.io) or prefer a more minimal initial installation.
