...
- [Vim](https://www.vim.org) Visual text editor for the terminal. Does
  ...
  Here is a more condensed [cheat sheet][vim-cheat] that is suitabe for
  printing. There is also a universe of [plugins][vim-plugins] to add
  functionality and customize the look and feel.
